<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion pr-0" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('home.index')}}">
        ...
        <div class="sidebar-brand-text mx-3">journab.com</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUsers" class="collapse
         {{request()->is('*panel/management/users*')?'show':''}}
         {{request()->is('*panel/management/roles*')?'show':''}}
         {{request()->is('*panel/management/permissions*')?'show':''}}
         " aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item   {{request()->is('*panel/management/users*')?'font-weight-bold':''}} " href="{{ route('admin.users') }}"> لیست کاربران</a>
                <a class="collapse-item {{request()->is('*panel/management/roles*')?'font-weight-bold':''}}" href="{{route('admin.roles.index')}}">  گروه های کابری</a>
                <a class="collapse-item {{request()->is('*panel/management/permissions*')?'font-weight-bold':''}}" href="{{route('admin.permissions.index')}}"> پرمیژن</a>
