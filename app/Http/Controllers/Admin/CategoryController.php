...
class CategoryController extends Controller
{
    ...
    public function getCategoryAttributes4(Category $category){
        $attrs=$category->attributes()->wherePivot('is_variation',0)->get();
        $variation=$category->attributes()->wherePivot('is_variation',1)->first();
        return ['attributes'=>$attrs,'variation'=>$variation];
    }
}
